    ...
    <div className="login-shell">
      <div className="login-card dvpe-card">
        <div className="login-brand">
          ...
          <div>
            <div className="login-brand-title">DVPE Dashboard</div>
            <div className="login-brand-sub">Akses internal - Penyidik & Petugas</div>
          </div>
        </div>

        <div className="dvpe-alert dvpe-alert-info" style={{ marginBottom: 16 }}>
          Mockup demo - gunakan kredensial: <strong>admin / admin</strong>
        </div>
        ...
        <div className="login-footnote">
          Akses gagal berulang akan dikunci sementara untuk mencegah brute force.
        </div>
      </div>
    </div>
  );
